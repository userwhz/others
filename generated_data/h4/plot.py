...
# 1. 定义键长列表
bond_lengths = [round(x, 1) for x in np.arange(0.4, 4.4, 0.2)]
...
methods_map = {
    'H4_cmopt_res': 'CCG ',
    'OverlappedGrouping_energies': 'OGM',
    'ShadowGrouping_energies': 'SG',
    'Derandomization_energies': 'Derandomization',
    'RandomPaulis_energies': 'CS'
}
# 6. 样式设置
styles = {
    'H2_cmopt_res': {
...
print(f"=== 开始绘制 H4 Scaling 图 (Shot={target_shot}) ===")
...
pdf_path = os.path.join(output_dir, f'H4_Bond_Scaling_RMSE_at_{target_shot}.pdf')
