...
output_dir = os.path.join(script_dir, 'plots_klocal_paper_v2')
...
file_map = {
    ...
    'ShadowGrouping': 'klocal_H2O_sto3g_n14_sg_res.txt',
    'OverlappedGrouping': 'klocal_OverlappedGrouping.txt',
    'klocal_cmopt_res': 'klocal_corecode_14q_H2O_sto3g_res_run1.txt'
}
...
pdf_path = os.path.join(output_dir, f'Klocal_Error_7qubits.pdf')
plt.savefig(pdf_path, bbox_inches='tight', pad_inches=0.12, dpi=300, format='pdf')
plt.close()
print(f"  -> 生成: {pdf_path}")

print(f"\n✅ 7 比特 k-local 结果图生成完成！")
