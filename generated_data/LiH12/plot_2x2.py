...
output_dir = os.path.join(script_dir, 'plots_LiH12_paper_v2')
...
file_map = {
    'RandomPaulis': 'LiH12_RandomPaulis.txt',
    'Derandomization': 'LiH12_Derandomization.txt',
    'ShadowGrouping': 'LiH12_ShadowGrouping.txt',
    'LiH_12jw_res': 'LiH_12jw_res.txt'
}
...
pdf_path = os.path.join(output_dir, f'LiH12_Error_12qubits.pdf')
plt.savefig(pdf_path, bbox_inches='tight', pad_inches=0.12, dpi=300, format='pdf')
plt.close()
print(f"  -> 生成: {pdf_path}")

print(f"\n✅ 12 比特 LiH 结果图生成完成！")
print(f"   • 使用完整 6 个 shot 点绘图")
