...
def main() -> None:
	parser = argparse.ArgumentParser(
		description="Generate H2O STO-3G qubit Hamiltonian (14 qubits) and state files."
	)
	parser.add_argument(
		"--atom",
		type=str,
		default="O 0.000000 0.000000 0.000000; H 0.000000 -0.757160 0.586260; H 0.000000 0.757160 0.586260",
	...
	parser.add_argument(
		"--output-dir",
		type=str,
		default="haozhaowu/H2O/hamil_class",
		help="Directory for generated files.",
	)
	parser.add_argument(
		"--tag",
		type=str,
		default="H2O_sto3g_14",
		help="Tag used in output file names.",
	)
	parser.add_argument(
		"--skip-dense-hamiltonian",
		action="store_true",
		help="Skip dense Hamiltonian .npy export. For 14 qubits, dense matrix is about 4GB.",
	)
	parser.add_argument(
	...
	if qubit_op.num_qubits != 14:
		raise ValueError(
			f"Expected 14 qubits for H2O STO-3G, got {qubit_op.num_qubits}. "
			"Check geometry/basis/active-space settings."
		)
